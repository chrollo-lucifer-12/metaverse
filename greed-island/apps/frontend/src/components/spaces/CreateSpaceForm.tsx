...
const CreateSpaceForm = ({onClose} : {onClose : any}) => {
    const {errors,isPending,onFormSubmit,register,watch,reset} = useCreateSpace();
    ...
    return <form onSubmit={onFormSubmit}>
        ...
        <FormGenerator inputType={"select"} register={register} name={"mapId"} errors={errors} options={maps}/>
